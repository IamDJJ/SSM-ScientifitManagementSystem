...
<table class="border" width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td height="565" align="center" valign="top" class="bg_low"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="middle" class="bgtop"><font color=""><b>项目列表</b></font>
...
<a href="<%= request.getContextPath()%>/xiangmu/modify?keyid=${mymap.xmid}"  >修改</a>|<a href="<%= request.getContextPath()%>/xiangmu/detail?keyid=${mymap.xmid}"  >详情</a></td>
