...
<table class="border" width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td height="565" align="center" valign="top" class="bg_low"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="middle" class="bgtop"><font color=""><b>合同变更列表</b></font> </td>
      </tr>
    </table>
<TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1  bordercolor="#33CCCC">
  <TBODY>
			  ...
			  <td>序号 </td>
					         ...
					         <td width="9%" height="25"><strong>变更说明</strong></td>
	  ...
	  <c:forEach items="${mylist}" var="mymap" varStatus="status">  
              <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"' onmouseout='this.style.background="#FFFFFF"'>
			          <td  align="center" height="28" >${status.count}</td>
					        ...
					        <td  align="center" height="28">${mymap.bgsmbgr}</td>
					        <td  align="center" height="28">${mymap.sj}</td>
					        <td  align="center" height="28">${mymap.zt}</td>
					
                <td ><a href="<%= request.getContextPath()%>/htbg/del?keyid=${mymap.htbgid}"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
				
					<c:if test="${mymap.zt=='未审核'}">
<a href="<%= request.getContextPath()%>/htbg/modify?keyid=${mymap.htbgid}"  >审核</a>|

</c:if>
			
<a href="<%= request.getContextPath()%>/htbg/detail?keyid=${mymap.htbgid}"  >详情</a></td>
