...
form.action="<%=request.getContextPath()%>/leixing/update";
form.submit();
}
</script>
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
     ...
     <td ><input type="text"   name="lx" placeholder="输入类型"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${lx}"    /><i>	 <font color="red">*</font> </i></li></td>
