...
form.action="<%=request.getContextPath()%>/xmzj/update";
form.submit();
}
</script>
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
 ...
 <input type="hidden"   name="xm" placeholder="输入项目"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${xm}"    />
     ...
     <td >
	  ...
	  <textarea name="zjnr" cols="80" rows="5" placeholder="输入中检内容">${zjnr}</textarea>
<i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="sj" placeholder="输入时间"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${sj}"    /><i>	 <font color="red">*</font> </i></li></td>
  	     ...
  	     <input type="hidden" name="xmzjid" value="${xmzjid}">
</TBODY></TABLE>
</div>
