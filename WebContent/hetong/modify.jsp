...
form.action="<%=request.getContextPath()%>/hetong/updatea";
form.submit();
}
</script>
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
     ...
     <td ><input type="text"   name="htbh" placeholder="输入合同编号"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${htbh}"   readonly=""  /><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
  	         <tr>
     <td align=middle width=30% height=30>合同内容:</td>
     <td > 	 <textarea name="htnr" cols="80" rows="5" placeholder="输入合同内容">${htnr}</textarea><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
  	         <tr>
     <td align=middle width=30% height=30>起草时间:</td>
     <td ><input type="text"   name="qcsj" placeholder="输入起草时间"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${qcsj}"   readonly=""  /><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
  	         <tr>
     <td align=middle width=30% height=30>起草人:</td>
     <td ><input type="text"   name="qcr" placeholder="输入起草人"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${qcr}"  readonly=""   /><i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="zt" placeholder="输入状态"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${zt}"  readonly=""   /><i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="fj" placeholder="输入附件"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${fj}"  /> <iframe id="ifr" name="ifr" width="400" height="40" frameborder="no" scrolling="no" src="<%=request.getContextPath()%>/zscq/fileupload.jsp?kname=fj"></iframe><i>	 <font color="red">*</font> </i></li></td>
	   ...
	   <tr>
     <td align=middle width=30% height=30>变更记录:</td>
     <td > <textarea name="bgjl" cols="80" rows="5" placeholder="输入变更记录"></textarea><i>	 <font color="red">*</font> </i></li></td>
