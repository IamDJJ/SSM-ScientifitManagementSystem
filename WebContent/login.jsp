...
<style type="text/css">
body { margin: 0;padding: 0;font:12px 宋体;line-height:18px;text-align:left;color:#404040;background:url(images/bj.gif) no-repeat center top;}
...
<div class="m_ctr">
    ...
    <div class="t_mid"> 高校科研管理系统 登陆首页</div>
...
<div class="m_cp">Powered by  &copy; 2018, <a href="yonghu/zhuce.jsp" target="">用户注册</a></div>
</div>
    </form>
