...
form.action="<%=request.getContextPath()%>/xmjx/add";
form.submit();
}
</script>
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
	...
	%>
     ...
     <td >
	  <textarea name="jxsm" cols="80" rows="5" placeholder="输入结项说明"></textarea>
<i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="bz" placeholder="输入备注"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
