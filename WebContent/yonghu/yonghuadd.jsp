...
form.action="<%=request.getContextPath()%>/yonghu/add";
form.submit();
}
</script>
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
     ...
     <td ><input type="text"   name="xy" placeholder="输入学院"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
         <tr>
     <td align=middle width=30% height=30>QQ:</td>
     <td ><input type="text"   name="QQ" placeholder="输入QQ"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
         <tr>
     <td align=middle width=30% height=30>电话:</td>
     <td ><input type="text"   name="dh" placeholder="输入电话"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
...
<i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="nl" placeholder="输入年龄"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
