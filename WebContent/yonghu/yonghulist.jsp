...
<table class="border" width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td height="565" align="center" valign="top" class="bg_low"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="middle" class="bgtop"><font color=""><b>用户列表</b></font> </td>
      </tr>
    </table>
<TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1  bordercolor="#33CCCC">
  <TBODY>
			  ...
			  <td>序号 </td>
					         ...
					         <td width="9%" height="25"><strong>学院</strong></td>
			
					         <td width="9%" height="25"><strong>QQ</strong></td>
			
					         <td width="9%" height="25"><strong>电话</strong></td>
	  ...
	  <c:forEach items="${mylist}" var="mymap" varStatus="status">  
              <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"' onmouseout='this.style.background="#FFFFFF"'>
			          <td  align="center" height="28" >${status.count}</td>
					        ...
					        <td  align="center" height="28">${mymap.xy}</td>
					        <td  align="center" height="28">${mymap.QQ}</td>
					        <td  align="center" height="28">${mymap.dh}</td>
					        <td  align="center" height="28">${mymap.xb}</td>
					        <td  align="center" height="28">${mymap.nl}</td>
					
                <td ><a href="<%= request.getContextPath()%>/yonghu/del?keyid=${mymap.yhid}"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
<a href="<%= request.getContextPath()%>/yonghu/modify?keyid=${mymap.yhid}"  >修改</a>|<a href="<%= request.getContextPath()%>/yonghu/detail?keyid=${mymap.yhid}"  >详情</a></td>
